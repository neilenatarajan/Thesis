...
\usepackage{tabularx} % Required for inserting images
...
\title{Selection-Centred AI: The Role of HCI in Supporting Novel Solutions to Modern Problems in Global Scholarship Selection}
...
\include{text/body/ch-background}
...
\include{text/appendices/app-terminology}
