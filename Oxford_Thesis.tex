...
\title{Selection-Oriented AI: The Role of HCI in Supporting Solutions to Explainability, Diversity, and Plagiarism in Global Scholarship Selection}
...
\newcommand{\rise}{Rise}
\newcommand{\eit}{The Ellison Scholars}
...
\flushbottom
\include{text/body/ch-intro}
\include{text/body/ch-context}
\include{text/body/ch-methods}
\include{text/body/ch-xai}
\include{text/body/ch-genai}
\include{text/body/ch-diversity}
\include{text/body/ch-spf}
\include{text/body/ch-discussion}
...
\include{text/appendices/app-programs}
\include{text/appendices/app-protocols}
\include{text/appendices/app-math}
\include{text/appendices/app-figures}
