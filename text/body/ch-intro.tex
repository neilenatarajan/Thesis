...
% You discuss “competing values” abstractly. Can you give some examples of values?  Please include “values” as a key term, and examples of these.
...
% Terms – Instead of listing terms in an arbitrary order here without a connecting narrative, it may be better to include such terms in a simple alphabetised glossary, and spend time here discussing key background elements, separating key terms from methods (which would be better placed in a Methods chapter). This section also introduces new terms, such as SOAI which might be better done under Contributions.
...
% Diversity – The definition provided for such an essential and central concept of your thesis seems a tad inadequate. You use the quote “The heterogeneity of elements in a set about a class that takes different values, such as species in an eco-environment, or ethnicity in a population” – but do not discuss what is a class, what are the values and how does this map to selection problem?  What about non-set theoretic definitions of diversity – e.g. group diversity, intersectional/individual uniqueness and diversity?  There should be an expanded discussion of diversity including multiple disciplinary perspectives, including those discussing challenges of applying straightforward set-theoretic diversity metrics to human beings.
...
% Selection – May be useful to scope that this thesis explicitly deals with positive discrimination in talent selection (in the cohort or individual contexts as discussed above) as opposed to other aspects of selection.
...
% Section 1.2: I don’t entirely agree that HCAI would centre the task around Selectors. It would centre around anyone involved in the process: selectors, their team/bosses, the applicants, etc…. if done properly! Perhaps it is correct to say that many people would choose to centre it around selection?
