...
% To-do: this isn't really a discussion. A discussion would say "here's what I learned, here's what I'm not sure about, here's limitations, this is what makes this domain hard or complicated, this is how it relates back to debates and paradigms in HCI..."

% to-do: relate this to other HCI discussions. If someone else is doing AR in a different area, is there anything I've done that shows strengths or weaknesses of those areas. What relates to HCAI research / value centred design / policy stuff?
...
% to-do: there's a huge focus on automation bias in the context of AI for decision support, but a real strength here is that AI can be used outside of decisions for individuals. Also, mention maybe that we've avoided implementing individual-level stuff because of the potential for automation bias.

%  - critical attention on algorithms Kitchin_2017

%  - for a discussion about algorithmic bias: what is bias? And do algorithms challenge or enforce morals? There is a strong deference to the precedent; Barocas_Hood_Ziewitz_2013. But also, algorithms could be designed to defer to any moral code. The key is that there would have to be a moral code there.

%  - individual and distributive notions of fairness. fairness across subgroups. fairness gerrymandering. pmlr-v80-kearns18a
...
% to-do: say "if you can make this process work better, there's reason to believe you can make other related decision-making processes work better as well". This applies to every selection context and maybe even non-selection decision-making contexts.