...
\begin{figure}
    \includegraphics[width=\textwidth]{figures/diversity_is.png}
    ...
    \Description{Participant definitions of diversity.}
...
\begin{figure}[htbp]
    ...
    \label{fig:flowchart}
    \Description{A Flowchart depicting the relationship between studies.}
\end{figure}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=\textwidth]{figures/diversity_triangle.png}
    ...
    \Description{A Venn diagram with `Diversity' in the centre, featuring `Different Perspectives', `Representativeness', and `Contextualising Applications' on each corner. Each theme has been placed into one of the overlapping sections.}
\end{figure}
