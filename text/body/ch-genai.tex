...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=\textwidth]{plots/study_flow.png}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.8\textwidth]{plots/decision_matrix.png}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.8\textwidth]{plots/desiderata_matrix.png}
...
\begin{figure}[htb]
  \centering
  \includegraphics[width=0.4\textwidth]{plots/roc_curve.jpg}
...
\begin{figure}[htb]
  \centering
  \includegraphics[width=0.8\textwidth]{plots/histogram.jpg}
...
\begin{figure}[htb]
  \centering
  \includegraphics[width=0.8\textwidth]{plots/confusion.jpg}
...
\begin{figure}[htb]
  \centering
  \includegraphics[width=0.4\textwidth]{plots/calibration.jpg}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.8\textwidth]{plots/satisfaction_matrix.png}
