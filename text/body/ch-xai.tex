...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=.9\textwidth]{plots/taxonomy.png}
    ...
    \label{fig:taxonomy}
    \Description{A visual taxonomy of explanation types.}
\end{figure}
...
\begin{figure*}[htbp]
    \centering
    \includegraphics[width=\textwidth]{plots/online_flowchart.png}
    ...
    \Description{A Flowchart depicting the flow of the workshops.}
...
\begin{equation}
    \Delta any(trust_{x1,x2} \neq trust_{x1,x3}) | \neg correct_{AI} \text{ for } x1 \in \{behavioural, attitudinal\} \and x2,x3 \in \{SHAP, Anchor, Confidence\}
\end{equation}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=.9\textwidth]{plots/case_flowchart.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=.9\textwidth]{plots/sample_case.png}
...
One core limitation of our work relates to the choice of tasks. While $salary$, $credit$, and $selection$ are closely related tasks, the distinction between \emph{in-process} and \emph{ex-post} decisions may be complicated by other distinctions between the three tasks. Future work should investigate the this distinction in other contexts.
...
Finally, differences between the personalities of our online study and participatory design participants may limit the external validity of our results. Similarly, though we choose popular post-hoc xAI methods \cite{Barocas_Selbst_Raghavan_2020,Kumar-et-al,Weerts-et-al-evaluation,Ribeiro-et-al-alime}, our choice of SHAP and Anchor limits applicability to other methods.
