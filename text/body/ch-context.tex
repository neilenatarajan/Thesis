...
\begin{table}[htbp]
  ...
  \begin{tabular}{l r p{0.33\linewidth}p{0.33\linewidth}}
      ...
      \midrule
      \emph{Salary} & \ref{ch:xai} & A program may desire to deferentially treat a person based on an estimate of their salary.\footnote{Note that in the case of both \emph{Salary} and \emph{Credit}, the decision point listed here differs slightly from the prompt as posed to study participants from Chapter \ref{ch:xai}. The framing in Chapter \ref{ch:xai} was presented to study participants, while the framing here is most interesting from our perspective.} & AI-calculated estimations of salary range based on census information of that individual. \\ 
      \emph{Credit} & \ref{ch:xai} & A program may desire to accept or deny a hypothetical person's loan application based on their creditworthiness.\footnote{See above.} & An AI-generated prediction of whether someone will be severely delinquent in making a credit payment. \\ 
