...
Additionally, the Ellison Scholarship relies on a divergent thinking assesment based on Guildford's Alternative Uses Task (AUT) \cite{}. % To-do: more on the aut, including scoring methodology and a sample item.
