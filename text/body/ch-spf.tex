...
For comprehensive background on economic perspectives on selection and algorithmic decision-making in talent selection, see Chapter \ref{ssec:context_ai_talent_selection}. Here we focus on the specific theoretical contribution and field deployment this chapter presents.
