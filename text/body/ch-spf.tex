...
% \section{Motivation}
% % this ties the rest of the chapter to the rest of the thesis.

% \section{Introduction}\label{sec:spfintro}
% This is an implementation of the technology probe that is more than just a probe. We've implemented and deployed a system. It's not a probe anymore. This is a real-world deployment. "Field deployment" or "field study" maybe?

% to-do: say this research has actually been implemented and deployed in the field; it affected the selection of a cohort of scholars in a high-profile scholarship program. DST affected the applications of 5000 people in the cohort. It's an important real-world impact and justifies why these tools are necessary.
...
% \section{Methodology}\label{sec:spfmethod}
% \subsection{Evaluating Organisational Decision-Making}

% % - We desire to evaluate Prototype \ref{fig:diversity} on real results, rather than satisfaction
% % - But there is no ground truth of decision-making here
% % - So we rely on a model of talent selection that we call the SPF
% % - This model is \dots

% \subsection{Implementing Prototype \ref{fig:diversity} in the Field}
% % - In order to implement Prototype \ref{fig:diversity} in the field, we similarly rely on the SPF model
% % - However, calculating optima under this model in NP-hard
% % - So we use a greedy algorithm to approximate the SPF

% \section{Selection Decisions With and Without Prototype \ref{fig:diversity}}
% % - Without the prototype, the scholarship program selects suboptimal cohorts
% % - With the prototype, they improve on the model
% % - We also see improvements on other measures \dots

% \section{A Theory of Why}

% % - this organisation has already demonstrated a commitment to diversity
% % - so why does our prototype help?
% % - augmenting the SPF with a computational cost term helps explain this inefficiency
% % - it also explains why the organisation finds themselves at a similar diagonal

% \section{Discussion}

% % discuss or something lol
